#' construct Canvas xml code for a multiple choice question
#'
#' This function constructs Canvas xml code for a multiple choice question
...
write_quiz_canvas_mc= function(question, answer_counter) {
  ...
  # initialize output
  output= write_quiz_canvas_question_preamble("multiple_choice_question", points_possible, v_answer_identifiers, question_key)
  ...
  output2= c(output2, write_in_wrapper(output3, "response_lid", s_wrappertag="ident=\"response1\" rcardinality=\"Single\"", block=TRUE))
