...
Q_Integrity <- function(sEmailaddress, sVersion = "for normal time students", iVersion = 120) {
  
  sText <- c(
    "<strong><big>Welcome to the BSTAT written exam.</big></strong>",
    sprintf("You are looking at the version %s (so %d minutes). If you are entitled to <strong>extra time</strong>, close the current quiz now and go to the extra time exam quiz.", sVersion, iVersion),
