...
#                            TestName = "NORMAL TIME Business Statistics 2020/06/05",
#                            TestName = "EXTRA TIME Business Statistics 2020/06/05",
                            TestName = "CRASH VERSION Business Statistics 2020/06/05",
                            IntroText = c(sprintf("For emergency questions during the exam, send an email to %s", EmailAddress)
                                          )
                            )
...
Counters <- WriteQ(Q_Integrity(EmailAddress), Counters)
closeblock(QuizFile)
...
sprintf("\n\nEmails are sent to %s", EmailAddress)
